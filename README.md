...
React Frontend renders using custom font tileset
       ↓
Player input → sent back to LLM for next state
...
│                   ↓          ↓          ↓            │
│  ┌──────────────┐ ┌──────────────┐ ┌──────────┐   │
│  │   World      │ │  Narrative   │ │ Inventory│   │
│  │   Memory     │ │   Memory     │ │  State   │   │
│  │ (rooms/map)  │ │ (story log)  │ │ (items)  │   │
│  └──────────────┘ └──────────────┘ └──────────┘   │
└──────────────────┬──────────────────────────────────┘
                   ↓
┌─────────────────────────────────────────────────────┐
│               React Frontend                         │
│  • Renders tilemap using custom font                │
│  • Displays narrative descriptions                   │
│  • Shows inventory                                   │
